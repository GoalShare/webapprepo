                  ...
                  if (authorizationResult && !authorizationResult.error) {
                    ...
                    for(var i=0;i<result.feed.entry.length;i++){
                        ...
                        if(x==undefined){
                          ...
                          console.log(y.$t);
                          text =text+'<div class="col l6"><div class="card" style="width:100%; height:70%;"><div class="row"><div class="col l4"> <input type="checkbox" id="'+i+'"/><label for="'+i+'"></label><img src="img/Cornmanthe3rd-Plex-Communication-gmail.ico" height="40px" width="40px"></div><div class="col l8">'+y.$t+'<br><span style="font-size:10px;">'+x[0].address+'</span></div></div></div></div>';
