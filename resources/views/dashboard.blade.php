                  ...
                  if (authorizationResult && !authorizationResult.error) {
                    ...
                    for(var i=0;i<result.feed.entry.length;i++){
                        ...
                        if(x==undefined){
                          ...
                          text =text+'<input type="checkbox" id="'+i+'"/><label for="'+i+'"></label><img src="img/Cornmanthe3rd-Plex-Communication-gmail.ico" height="50px" width="50px"><label for="'+i+'"></label>'+x[0].address+'<hr>'+'<br/>';
