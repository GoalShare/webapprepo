                  ...
                  if (authorizationResult && !authorizationResult.error) {
                    ...
                    for(var i=0;i<result.feed.entry.length;i++){
                        ...
                        if(x==undefined){
                          ...
                          console.log(y.$t);
                          text =text+'<div class="col l6"><div class="row"><div class="col l3"><input type="checkbox" id="'+i+'"/><label for="'+i+'"></label><img src="img/Cornmanthe3rd-Plex-Communication-gmail.ico" height="30px" width="30px">&nbsp&nbsp</div><div class="col l9">'+y.$t+'<br><span style="font-size:10px;">'+x[0].address+'</span></div></div></div>';
