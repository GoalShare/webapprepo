                  ...
                  if (authorizationResult && !authorizationResult.error) {
                    ...
                    for(var i=0;i<result.feed.entry.length;i++){
                        ...
                        if(x==undefined){
                          ...
                          text =text+'<input type="checkbox" id="'+i+'"/><label for="'+i+'"></label><img src="img/Cornmanthe3rd-Plex-Communication-gmail.ico" height="50px" width="50px">'+x[0].address+'<hr>'+'<br/>';
              ...
              <div id="myModal11" class="modal"style="z-index:4000;">
                ...
                <div class="modal-content">
                  ...
                  <div class="bottom" style="bottom:100px; position:fixed;">
                    <button class="btn btn-floating right">Send Invite</button>
                    <button class="btn btn-floating left">Reset</button>
                  </div>
