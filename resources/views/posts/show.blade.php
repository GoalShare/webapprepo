...
<meta property="og:description" content="{!!str_limit($post->body, $limit = 20)!!}"/>
...
@section('title-meta')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <a class="facebook customer share" href="https://www.facebook.com/sharer.php?u={{Request::fullUrl()}}"
               title="Facebook share" target="_blank" style="margin-left: 83%"
               class="btn btn-social-icon btn-xs btn-facebook"><i class="fa fa-facebook"></i></a>
            <a class="google_plus customer share" href="https://plus.google.com/share?url={{Request::fullUrl()}}"
               title="Google Plus Share" target="_blank" style="margin-left: 3%"
               class="btn btn-social-icon btn-xs btn-google-plus"><i class="fa fa-google-plus"></i></a>
            <a class="linkedin customer share"
               href="https://www.linkedin.com/shareArticle?mini=true&url={{Request::fullUrl()}}" title="linkedin Share"
               target="_blank" style="margin-left: 3%" class="btn btn-social-icon btn-xs btn-twitter"><i
                                        ...
                                        <div class="comment-box">
                                            <div class="comment-head">
                                                <h6 class="comment-name by-author">
                                                    <a style="float: left"
                                                       href="/">{{ $comment->author->fname}} {{ $comment->author->lname}}</a>
                                                    <span style="font-size: 10px;margin-top: 3px;margin-left: 10px">{{ $comment->created_at->format('M d,Y \a\t h:i a') }}</span>
                                                </h6>
