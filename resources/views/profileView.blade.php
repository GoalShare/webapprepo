        ...
        <script type="text/javascript">
            ...
            <div id="myModal11" class="modal modal-fixed-footer" style="height:600px;max-height:600px;">
              <div style="height:100px;">
                ...
                <div style="height:25px;background-color:#EEEEEE;"><span><span>&nbsp&nbsp&nbsp&nbsp</span><input type="checkbox" id="chk" onclick="toggle(this);" />Select all<label for="chk"></label></span></div>
              </div>
              <!-- Modal content -->
