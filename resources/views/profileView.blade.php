...
<button style="background-color:#0D6E8A;border: none;width:100px;height:30px;" class="btn"><script type="IN/Share" data-url="http://www.lifewithgoals.com/" data-counter="right"></script></div></button>
  </div>
