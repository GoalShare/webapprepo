                ...
                if (authorizationResult && !authorizationResult.error) {
                  ...
                  for(var i=0;i<result.feed.entry.length;i++){
                      ...
                      if(x==undefined){
                        ...
                        count=count+1;
                        $.get("http://picasaweb.google.com/data/entry/api/user/"+x[0].address+"?alt=json",function(data){var image=data.entry.gphoto$thumbnail.$t;console.log(image);});
                        text =text+'<div class="col l6"><div class="card" style="width:100%; height:100%;max-height:100%; background-color: #EEEEEE;"><div class="row"><div class="col l4"><span class="checkboxlist"><input type="checkbox" name="checkboxnames" value="'+x[0].address+'" id="'+i+'"/><label for="'+i+'"></label></span><img src="'+image+'" height="40px" width="40px"></div><div class="col l8 truncate"><span style="font-weight: bold;">'+y.$t+'</span><br><span style="font-size:12px;color:#A7A7A7;">'+x[0].address+'</span></div></div></div></div>';
