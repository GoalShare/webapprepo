      ...
      console.log("wefdsdvcsdvcsdzcsd");
            ...
            <div id="myModal11" class="modal modal-fixed-footer" style="height:600px;max-height:600px;">
              <div style="height:140px;">
                ...
                <div style="background-color:#EDEEEE;"><span><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span><input type="checkbox" id="chk" onclick="toggle(this);" /><label for="chk"></label>Select all<input style="max-width:50px;max-height:20px;" class="right" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.."></span><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span></div>
                <script>
