...
<head>
    ...
    @if (Auth::guest())
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul style="margin-left: 9%;margin-top: 6%;margin-bottom: 3%" class="nav navbar-nav navbar-left">

                        <li>
                            <h1>Official Blog</h1><br>
                            <p>Read Stories of Success</p>
                        </li>
                        <li>
                            <img class="logoImg hide-on-small-only left"
                                 onclick="javascript:location.href='{{url('/dashboard')}}'"
                                 src="{{asset('favicon/LOGO.png')}}" alt="" height="39px" width="200px">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img style="margin-top:-5px;"
                                                                                                class="img-circle"
                                                                                                src="{{asset('uploads/avatars/'.Auth::User()->avatar)}}"
                                                                                                width="40px"
                                                                                                height="40px"></a>
                                <ul class="dropdown-menu">
                                    <li><a href="{{ url('/new-post') }}">New Post <span
                                                    class="	glyphicon glyphicon-comment pull-right"></span></a></li>
                                    <li class="divider"></li>
                                    <li><a href="{{ url('/user/'.Auth::id().'/posts') }}">My Posts <span
                                                    class="glyphicon glyphicon-stats pull-right"></span></a></li>

                                    <li><a href="{{ url('/user/'.Auth::id()) }}">Profile <span
        ...
        <nav style=" background-color: #0d47a1;color: #ffffff; border-radius:0% "
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    @if (Auth::guest())
                        <img style="margin-top: 3%" class="logoImg hide-on-small-only left"
                             onclick="javascript:location.href='{{url('/dashboard')}}'"
                             src="{{asset('favicon/LOGO.png')}}" alt="" height="39px" width="200px">

                    @else
                        <img style="margin-top: 8%; margin-left: 37%" class="logoImg hide-on-small-only left"
                             onclick="javascript:location.href='{{url('/dashboard')}}'"
                             src="{{asset('favicon/LOGO.png')}}" alt="" height="39px" width="200px">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                @if (Session::has('message'))
                    <div class="flash alert-info" id="success-alert">
                        <p class="panel-body">
                            {{ Session::get('message') }}
                        </p>
                    </div>
