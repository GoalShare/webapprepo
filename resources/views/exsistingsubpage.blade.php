...
<div class="container">
  ...
  @foreach ($learningboardtable as $learningboardtables)
    @if ($learningboardtables->ID==$lbid)
      <center><h4 class="">Upload Your Files to the {{$learningboardtables->LB_Name}},{{$learningboardtables->CT_ID}},{{$learningboardtables->CC_ID}},{{$learningboardtables->SC_ID}},{{$learningboardtables->ID}}</h4></center>
      <script>
