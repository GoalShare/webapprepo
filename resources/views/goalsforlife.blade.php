...
<html>
  ...
  <div class="ui  segment" style="background-color: #000000;">
    <div class="ui horizontal segments" style="background-color: #000000;padding-top:-10px;">
    <div class="ui segment">
      <p></p>
    </div>
    <div class="ui segment center aligned">
      <p class="item"><img src="{{asset('img/new_logo.png')}}" alt="" height="100px" width ="250px"><span class="ui header" style="color:white;font-size:90px;">LIFE   WITH   GOALS</span></p>
    </div>
    <div class="ui segment">
      <p></p>
    </div>
  ...
  <div class="ui grid" style="background-color:#212121;font-size:20px;height:50px;">
<div class="one wide column right aligned" style="color:white;">Blog</div>
<div class="two wide column left aligned" style="color:white;">About Us</div>
<div class="eight wide column center aligned" style="color:white;"></div>
<a target="_blank" title="find us on Facebook" href="https://www.facebook.com/LifeWithGoals/"><img alt="follow me on facebook" src="{{asset('img/313485-32.png')}}" border=0></a>
<a target="_blank" title="follow me on youtube" href="https://www.youtube.com/channel/UCP2DuuEb-pU1C1ASw0ZJYRA?view_as=subscriber"><img alt="follow me on youtube" src="{{asset('img/1218148-32.png')}}" border=0></a>
<a target="_blank" title="follow me on instagram" href="https://www.instagram.com/lifewithgoals_1/"><img alt="follow me on instagram" src="{{asset('img/281827-32.png')}}" border=0></a>
<a target="_blank" title="follow me on twitter" href="http://www.twitter.com"><img alt="follow me on twitter" src="{{asset('img/313466-32.png')}}" border=0></a>
  ...
  <body>
    ...
    <div class="ui segment">
      ...
      <div class="ui grid">
        ...
        <div class="ui seven wide column center aligned">
      <div class="image">
        <img src="img/responsive_webdesign_and_seo.jpg" width="600px" height="400px">
      </div>
      <div class="content">
      ...
      <div class="ui nine wide column center aligne">
        <div class="ui top attached tabular menu">
          <a class="item  active" data-tab="first"><i class="large circular power icon" id="signin"></i> Login</a>
          <a class="item" data-tab="second"><i class="large circular users icon" id="regisitericon"></i> Sign Up</a>

        </div>
        <div class="ui bottom attached tab segment active" data-tab="first">
          {{-- <h2 class="ui center aligned icon header">
            <i class="circular sign in icon" id="signin"></i>
              Login
            </h2>
              <div class="ui divider"></div> --}}
              <div class="ui grid" style="height:50px;"></div>
              <form class="ui form" role="form" method="POST" action="{{ route('login') }}">
                {{ csrf_field() }}
                <div class="ui grid">
                ...
                <div class="ui grid">
                  ...
                  <div class="six wide column">
                    <div class="field {{($errors->has('email')||$errors->has('password'))?'error':''}}">
                      <input type="password" name="password" placeholder="Password">
                      {{-- <a style="color:black;" href="{{ route('password.request') }}">Forgot your Password ?</a> --}}
                    </div>
                  </div>
                  <div class="five wide column"></div>
                </div>
    ...
    {{-- @if (($errors->has('email')||$errors->has('password'))) --}}
      ...
      <div class="eight wide computer only eight wide tablet column"> --}}
        ...
        {{-- <div class="menu" id="rightmenu">
          ...
          {{-- </form>
          <div class="ui grid" style="height:160px;"></div>
        </div> --}}
          {{-- </div>
    </div> --}}
      {{-- </div>
  ...
  {{-- <div class="ui grid"> --}}
    ...
    <div class=" column row">
      <div class="computer only column">
        <div class="">
          <div class="ui inverted footer segment " style="background-color:#212121; ">
            <div class="ui container">
              <div class="ui  stackable  divided equal height stackable grid">
                <div class="thirteen wide column">
                  <a href="#" style="color:white;font-size:20px;" class="item">English(UK)</a>&nbsp&nbsp&nbsp
                  <a href="#" style="color:white;font-size:20px;" class="item">Sinhalese</a><br>
              ...
              <div class="ui grid" style=height:50px;></div>
                ...
                <div class="ui grid">
                    ...
                    <a href="#" style="color:white; font-size:20px;" class="item">Support </a>&nbsp&nbsp&nbsp
                    <a href="#" style="color:white; font-size:20px;" class="item">Work with us </a>
